...
namespace WhiteLagoon.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IUnitOfWork unitOfWork, IWebHostEnvironment webHostEnv)
        {
        ...
        {
            var villa = _unitOfWork.Villa.GetAll(incProps: "VillaAmenity").FirstOrDefault(x => x.Id == id);
            if (villa is null)
            {
