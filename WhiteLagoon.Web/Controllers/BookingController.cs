...
namespace WhiteLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IUnitOfWork unitOfWork, IWebHostEnvironment webHostEnv)
        {
        ...
        public IActionResult FinalizeBooking(int villaId, DateOnly checkInDate, int nights)
        {
            ...
            {
                VillaId = villaId,
                Villa = _unitOfWork.Villa.Get(u => u.Id == villaId, incProps: "VillaAmenity"),
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
            ...
            int roomAvailable = SD.VillaRoomsAvailable_Count(villa.Id, villaNoList, booking.CheckInDate, booking.Nights, bookedVillas);
        ...
        {
            string basePath = _webHostEnv.WebRootPath;
            ...
            //Update Template
            Booking bookingFromDb = _unitOfWork.Booking.Get(u => u.Id == id, incProps: "User,Villa");
        ...
        {
            _unitOfWork.Booking.UpdateStatus(booking.Id, SD.StatusComplete, booking.VillaNumber);
            _unitOfWork.Save();
