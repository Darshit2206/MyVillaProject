...
namespace WhiteLagoon.Web.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> GetTotalBookingRadialChartData()
        {
            ...
            var countByPrevMonth = totalBookings.Count(u => u.BookingDate >= prevMonthStartDate &&
            ...
            {
                increaseDecreaseRatio = Convert.ToInt32((countByCurrentMonth - countByPrevMonth) / countByPrevMonth * 100);
            }

            radialBarChartVM.TotalCount = totalBookings.Count();
            radialBarChartVM.CountInCurrentMonth = countByCurrentMonth;
            radialBarChartVM.HasRatioIncreased = currentMonthStartDate > prevMonthStartDate;
        ...
        public async Task<IActionResult> GetRegisteredUserChartData()
        {
            ...
            var countByPrevMonth = totalUsers.Count(u => u.CreatedAt >= prevMonthStartDate &&
        ...
        public async Task<IActionResult> GetRevenueChartData()
        {
            ...
            var countByPrevMonth = totalBookings.Where(u => u.BookingDate >= prevMonthStartDate &&
            ...
            radialBarChartVM.TotalCount = totalBookings.Count();
            radialBarChartVM.CountInCurrentMonth = (decimal)countByCurrentMonth;
            radialBarChartVM.HasRatioIncreased = currentMonthStartDate > prevMonthStartDate;
            radialBarChartVM.Series = new int[] { increaseDecreaseRatio };
