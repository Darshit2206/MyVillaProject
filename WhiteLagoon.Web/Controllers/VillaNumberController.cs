...
namespace WhiteLagoon.Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        {
            var villaNo = _unitOfWork.VillaNumber.GetAll(incProps: "Villa");
            return View(villaNo);
        }
        [HttpGet]
        ...
        {
            bool roomNoExists = _unitOfWork.VillaNumber.Any(u => u.Villa_Number == obj.VillaNumber.Villa_Number);

            if (ModelState.IsValid && !roomNoExists)
            {
        ...
        public IActionResult Delete(VillaNumberVM obj)
        {
            VillaNumber? objFromDb = _unitOfWork.VillaNumber
                .Get(u => u.Villa_Number == obj.VillaNumber.Villa_Number);
